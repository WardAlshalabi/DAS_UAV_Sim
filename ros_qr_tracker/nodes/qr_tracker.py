                ...
                if pil_img:
                    ...
                    if matches:
                        for match in matches:
                            ...
                            max_x=max(tl[0],bl[0],br[0],tr[0])
                            min_x=min(tl[0],bl[0],br[0],tr[0])
                            max_y=max(tl[1],bl[1],br[1],tr[1])
                            min_y=min(tl[1],bl[1],br[1],tr[1])
                            ...
                            if self.show_matches:
                                ...
                                cv2.line(cv_img,(x,y),(width/2,height/2), (0,0,255),3)
                            percept = Percept()
