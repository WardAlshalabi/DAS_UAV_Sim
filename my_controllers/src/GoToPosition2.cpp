...
int main(int argc, char **argv){
  ...
  std::string cmd_topic = "/uav" + id_stream.str() + "/cmd_vel";
    ...
    */
    ...
    desired_Pos.x = path[index1][0];   //get desired x Position
    desired_Pos.y = path[index1][1];   //get desired y Position
    desired_Pos.z = path[index1][2];   //get desired z Position
    b=true;
    index1++;
